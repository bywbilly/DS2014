 ...
 * Please use option -std=c++11 when compiling this tester.
...
public:
    ...
    Info() {}
    string to_string(long long i) const
    {
        long long id=i;
        string res="";
        while(id)
...
vector<Info> v {
Info(5120309059LL, "宋沁芸"),
Info(5130309008LL, "周耀达"),
Info(5130309015LL, "胡云聪"),
Info(5130309016LL, "黄宇扬"),
Info(5130309017LL, "马豪君"),
Info(5130309019LL, "王  歆"),
Info(5130309021LL, "姚思秋"),
Info(5130309022LL, "张家睿"),
Info(5130309023LL, "张曦虎"),
Info(5130309026LL, "柏钧文"),
Info(5130309028LL, "邵俊儒"),
Info(5130309030LL, "王  凡"),
Info(5130309031LL, "王立力"),
Info(5130309032LL, "魏  楚"),
Info(5130309033LL, "翁  健"),
Info(5130309045LL, "白志豪"),
Info(5130309052LL, "陆嘉辉"),
Info(5130309056LL, "徐亦飞"),
Info(5130309058LL, "陈  迪"),
Info(5130309059LL, "李佳骏"),
Info(5130309062LL, "高  宇"),
Info(5130309066LL, "陈昕昀"),
Info(5130309067LL, "吉  妍"),
Info(5130309070LL, "施韩原"),
Info(5130309305LL, "陈子豪"),
Info(5130379062LL, "宋时伟"),
Info(5130379096LL, "姚京韬"),
Info(5130719033LL, "娄毅文"),
Info(5132029007LL, "曹家梁"),
Info(5132409031LL, "张億一"),
Info(5132409032LL, "高剑飞"),
Info(5132409033LL, "魏  涛"),
Info(5132409034LL, "郑宜霖"),
Info(5134139006LL, "夏  琛")};
...
void testHeap()
{
    ...
    printHeap(q3);
    ArrayList<Info> a;
    for (int i = v.size() - 1; i >= 0; --i) a.add(v[i]);
